  ...
  <div class="agent-view">
    <div class="agent-view-body">
      ...
      <div class="content">
        ...
        <section v-if="themeWelcomePanel && !isWorldlineHandoff" class="theme-welcome-panel">
...
import { getWorldlineAgentContextView } from '@/data/worldline'
...
const isWorldlineHandoff = ref(sessionStorage.getItem(WORLDLINE_HANDOFF_KEY) === '1')
...
const themeContextView = computed(() =>
  getWorldlineAgentContextView(activeThemeId.value, themeContextStore.activeContext || {}) || {}
)
...
const syncWorldlineHandoff = () => {
  const hasThemeContext = Boolean(themeContextStore.hasActiveContext)
  const handoffFlag = sessionStorage.getItem(WORLDLINE_HANDOFF_KEY) === '1'
  isWorldlineHandoff.value = hasThemeContext && handoffFlag
}
...
const clearThemeContext = async () => {
  ...
  sessionStorage.removeItem(WORLDLINE_HANDOFF_KEY)
  isWorldlineHandoff.value = false
